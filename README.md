...
1. It's light: and for "light" I mean that thanks to features like references it can drastically lower the amount of files you would need; also it's design drastically lowers the amount of characters used making files more light too.
